...
#include "../stacked_widget/buttonlabel.h"
...
void ButtonLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ButtonLabel::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ButtonLabel::clicked)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject ButtonLabel::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_ButtonLabel.data,
      qt_meta_data_ButtonLabel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void ButtonLabel::clicked(QString _t1)
{
