...
#include "../tableview/inc/backendInterface.h"
...
const QMetaObject BackendInterface::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_BackendInterface.data,
      qt_meta_data_BackendInterface,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *BackendInterface::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_BackendInterface.stringdata0))
        return static_cast<void*>(const_cast< BackendInterface*>(this));
