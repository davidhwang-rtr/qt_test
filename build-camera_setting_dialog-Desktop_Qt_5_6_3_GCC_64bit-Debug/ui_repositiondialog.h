...
public:
    ...
    void setupUi(QDialog *Dialog_Reposition)
    {
        ...
        frame_jog = new QFrame(verticalLayoutWidget);
        frame_jog->setObjectName(QStringLiteral("frame_jog"));
        frame_jog->setFrameShape(QFrame::StyledPanel);
        frame_jog->setFrameShadow(QFrame::Raised);

        horizontalLayout->addWidget(frame_jog);
    ...
    {
        Dialog_Reposition->setWindowTitle(QApplication::translate("Dialog_Reposition", "Reposition", Q_NULLPTR));
        label_name->setText(QApplication::translate("Dialog_Reposition", "+X Camera", Q_NULLPTR));
